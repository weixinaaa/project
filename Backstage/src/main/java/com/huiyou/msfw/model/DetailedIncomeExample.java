...
public class DetailedIncomeExample extends PageExample {
    ...
    public DetailedIncomeExample(Integer pageNo, Integer pageSize) {
        super(pageNo, pageSize);
        oredCriteria = new ArrayList<Criteria>();
    }

    public DetailedIncomeExample(Integer pageNo, Integer pageSize, String orderByClause) {
        super(pageNo, pageSize);
        this.orderByClause = orderByClause;
        oredCriteria = new ArrayList<Criteria>();
    }
