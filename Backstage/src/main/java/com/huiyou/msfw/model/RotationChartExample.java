...
public class RotationChartExample extends PageExample {
    ...
    public RotationChartExample(Integer pageNo, Integer pageSize) {
        super(pageNo, pageSize);
        oredCriteria = new ArrayList<Criteria>();
    }

    public RotationChartExample(Integer pageNo, Integer pageSize, String orderByClause) {
        super(pageNo, pageSize);
        this.orderByClause = orderByClause;
        oredCriteria = new ArrayList<Criteria>();
    }
