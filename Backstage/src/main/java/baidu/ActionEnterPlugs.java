...
import baidu.define.ActionMap;
import baidu.define.BaseState;
import baidu.define.State;
import baidu.hunter.FileManager;
import baidu.hunter.ImageHunter;
import baidu.upload.Uploader;
...
public class ActionEnterPlugs extends ActionEnter {  
    ...
    //图片存储路径  
    private String saveRootPath="D:/group1/M00/ueditor/";  
