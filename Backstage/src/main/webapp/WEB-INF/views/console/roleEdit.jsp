	...
	<form class="layui-form" id="frm">
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" data-field="id" name="id" required
					lay-verify="required" placeholder="" autocomplete="off"
					class="layui-input" readonly="readonly" value="${role.id}">
			</div>
		</div>
		<div class="layui-form-item">
	...
	<script type="text/javascript">
		layui.use('form',function(){
			...
			form.on('submit(edRole)', function(data){
				   $.ajax({
					 type : 'POST',
					 url : '${pageContext.request.contextPath}/console/role/editRole',
					 data : data.field,
