    ...
    <div class="layui-inline">
        <form class="layui-form" action="">
            <div class="layui-input-inline">
                <input type="text" value="" placeholder="商家名称" class="layui-input search_input" id="name">
            </div>
        </form>
    </div>
...
<script>
    ...
    function getList(data) {
        CommonLoadList("../console/advertisement/getAdvertisementBusinessAll", data, page, "tmpList", "listView", "laypage");
    }
    ...
    function DetailEdit(id) {
        ...
        $(window).one("resize", function() {
            ...
            var index = layui.layer.open({
                title: "信息编辑",
                type: 2,
                content: "../console/advertisement/toEditAdvertisementBusiness?id="+id,
    ...
    $(window).one("resize", function() {
        $(".newsAdd_btn").click(function() {
            var index = layui.layer.open({
                title: "添加",
                type: 2,
                content: "AdvertisementBusinessAdd",
                success: function(layero, index) {
                    setTimeout(function() {
                        layui.layer.tips('点击此处返回', '.layui-layer-setwin .layui-layer-close', {
                            tips: 3
        ...
        layui.use('layer', function() { //独立版的layer无需执行这一句
            ...
            layer.open({
                ...
                yes: function(index, layero) {
                    $.post("../console/advertisement/deleteAdvertisementBusiness?id="+id, {  }, function (data)
                    {
                        if (data.code == 0) {
                            layer.msg("删除成功!");
                            $("#deldevice").hide();
