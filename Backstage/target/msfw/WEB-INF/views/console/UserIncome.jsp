...
<script id="tmpList" type="text/html">
    <table class="layui-table" lay-even lay-skin="row" id="tt">
        ...
        <tr>
            ...
            <%--<td>&lt;%&ndash;<a class="layui-btn layui-btn-mini layui-btn-primary " onclick=DetailEdit({{item.id}})>编辑</a>&ndash;%&gt;
...
<script>
    ...
    function getList(data) {
        CommonLoadList("../console/detailedIncome/getDetailedIncomeAll", data, page, "tmpList", "listView", "laypage");
    }
    ...
    function DetailEdit(id) {
        ...
        $(window).one("resize", function() {
            ...
            var index = layui.layer.open({
                title: "信息编辑",
                type: 2,
                content: "../console/user/toEdit?id="+id,
