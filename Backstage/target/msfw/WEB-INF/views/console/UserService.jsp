...
<script>
    ...
    function getList(data) {
        CommonLoadList("../console/DriverService/getDriverServiceAll?type=0", data, page, "tmpList", "listView", "laypage");
    }
    ...
    $(window).one("resize", function() {
        $(".newsAdd_btn").click(function() {
            var index = layui.layer.open({
                title: "添加",
                type: 2,
                content: "../console/DriverService/toAddDriverService?type=0",
                success: function(layero, index) {
                    setTimeout(function() {
                        layui.layer.tips('点击此处返回', '.layui-layer-setwin .layui-layer-close', {
                            tips: 3
