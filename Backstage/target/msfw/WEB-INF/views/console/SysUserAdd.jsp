    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" placeholder="请输入类型名称" id="username" value="">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" placeholder="请输入密码" id="passwrod" value="">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    ...
    layui.use(['form'], function() {
        ...
        $("#add").click(function() {
            ...
            $.ajax({
                type: "post",
                url: "../console/sysUser/addSysUser",
                data: {
