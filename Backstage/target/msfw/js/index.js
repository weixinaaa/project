...
layui.config({
	...
	var form = layui.form,
		...
		tab = layui.bodyTab({
			...
			url : "../console/resource/getList" //获取菜单json地址.0
		});
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							'<div class="admin-header-lock-img"><img src="images/avatar.jpg"/></div>'+
							'<div class="admin-header-lock-name" id="lockUserName">刘先生</div>'+
							'<div class="input_btn">'+
